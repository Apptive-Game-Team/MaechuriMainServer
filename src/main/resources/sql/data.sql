...
-- 2. 장소 (location) - 맵 데이터 포함 (type, x, y, width, height)
INSERT INTO public.location (scenario_id, location_id, name, type, x, y, width, height, can_see, cannot_see, access_requires)
VALUES
    (1, 1, '로비', 'room', 2, 2, 10, 15, '[]', '[]', null),
    (1, 2, '도서관', 'room', 15, 2, 8, 10, '[]', '[]', '{"item": "도서관 열쇠"}'),
    (1, 3, '주방', 'room', 25, 2, 10, 8, '[]', '[]', null),
    (1, 4, '복도', 'corridor', 12, 5, 3, 5, '[]', '[]', null);
...
VALUES
    (1, 1, '피 묻은 칼', 3, '주방 싱크대에서 발견된 피 묻은 식칼. 혈액형은 피해자의 것과 일치합니다.', '범행에 사용된 흉기일 가능성이 높습니다.', null, false, '[]', 1, 4),
    (1, 2, '찢어진 드레스 조각', 2, '도서관 책상 밑에서 발견된 값비싼 드레스의 찢어진 조각. 빅토리아 부인의 드레스와 일치합니다.', '몸싸움 중에 찢어진 것으로 보이며, 빅토리아 부인이 현장에 있었음을 시사합니다.', null, false, '[102]', 3, 5),
    (1, 3, '수수께끼의 쪽지', 1, '로비 테이블 위에 놓여 있던 쪽지. "모든 것을 끝내야겠어."라고 적혀 있습니다.', '피해자의 자살을 위장하기 위해 범인이 남긴 것일 수 있습니다.', null, true, '[]', 6, 6);
