...
ALTER TABLE scenario ADD COLUMN IF NOT EXISTS date DATE;

ALTER TABLE location ADD COLUMN IF NOT EXISTS floor_url VARCHAR(512);
ALTER TABLE location ADD COLUMN IF NOT EXISTS wall_url VARCHAR(512);
